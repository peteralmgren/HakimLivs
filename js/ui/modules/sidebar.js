...
export default class Sidebar extends UI {
    constructor(appendTo) {
        ...
        this.container.addEventListener("click", async (e) => {
          if(e.target.className == "list-group-item cat-selector px-3") await new Products(".products").showProducts(e.target.dataset.categoryName);
          if(e.target.className == "show-all list-group-item cat-selector px-3") await new Products(".products").showProducts("all");
        });
        this.showCategories();
    }
